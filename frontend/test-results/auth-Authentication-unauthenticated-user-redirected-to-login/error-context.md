...
- Name: auth.spec.js >> Authentication >> unauthenticated user redirected to login
...
Received string:  "http://localhost:5173/erp"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:5173/erp"
